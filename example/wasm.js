...
const gl = {
    ...
    imports: {
        ...
        bufferData(target, size, data, usage) {
            gl.context.bufferData(target, new Uint8Array(wio.instance.exports.memory.buffer, data, size), usage);
        },

        bufferSubData(target, offset, size, data) {
            gl.context.bufferSubData(target, offset, new Uint8Array(wio.instance.exports.memory.buffer, data, size));
        },
        ...
        compressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data) {
            gl.context.compressedTexImage2D(target, level, internalformat, width, height, border, new Uint8Array(wio.instance.exports.memory.buffer, data, imageSize));
        },

        compressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data) {
            gl.context.compressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, new Uint8Array(wio.instance.exports.memory.buffer, data, imageSize));
        },
        ...
        getVertexAttribPointerv(index, pname, pointer) {
            new Uint32Array(wio.instance.exports.memory.buffer, pointer)[0] = gl.context.getVertexAttribOffset(index, pname);
        },
        ...
        readPixels(x, y, width, height, format, type, pixels) {
            gl.context.readPixels(x, y, width, height, format, type, new Uint8Array(wio.instance.exports.memory.buffer, pixels));
        },
        ...
        texImage2D(target, level, internalformat, width, height, border, format, type, pixels) {
            gl.context.texImage2D(target, level, internalformat, width, height, border, format, type, new Uint8Array(wio.instance.exports.memory.buffer, pixels));
        },
        ...
        texSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels) {
            gl.context.texSubImage2D(target, level, xoffset, yoffset, width, height, format, type, new Uint8Array(wio.instance.exports.memory.buffer, pixels));
        },
        ...
        uniform1fv(location, count, value) {
            gl.context.uniform1fv(location, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform1iv(location, count, value) {
            gl.context.uniform1iv(location, new Int32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform2fv(location, count, value) {
            gl.context.uniform2fv(location, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform2iv(location, count, value) {
            gl.context.uniform2iv(location, new Int32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform3fv(location, count, value) {
            gl.context.uniform3fv(location, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform3iv(location, count, value) {
            gl.context.uniform3iv(location, new Int32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform4fv(location, count, value) {
            gl.context.uniform4fv(location, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        uniform4iv(location, count, value) {
            gl.context.uniform4iv(location, new Int32Array(wio.instance.exports.memory.buffer, value, count));
        },

        uniformMatrix2fv(location, count, transpose, value) {
            gl.context.uniformMatrix2fv(location, transpose, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },

        uniformMatrix3fv(location, count, transpose, value) {
            gl.context.uniformMatrix3fv(location, transpose, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },

        uniformMatrix4fv(location, count, transpose, value) {
            gl.context.uniformMatrix4fv(location, transpose, new Float32Array(wio.instance.exports.memory.buffer, value, count));
        },
        ...
        vertexAttrib1fv(index, v) {
            gl.context.vertexAttrib1fv(index, new Float32Array(wio.instance.exports.memory.buffer, v));
        },
        ...
        vertexAttrib2fv(index, v) {
            gl.context.vertexAttrib2fv(index, new Float32Array(wio.instance.exports.memory.buffer, v));
        },
        ...
        vertexAttrib3fv(index, v) {
            gl.context.vertexAttrib3fv(index, new Float32Array(wio.instance.exports.memory.buffer, v));
        },
        ...
        vertexAttrib4fv(index, v) {
            gl.context.vertexAttrib4fv(index, new Float32Array(wio.instance.exports.memory.buffer, v));
        },
